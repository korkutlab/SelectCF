...
print.SelectCF_base <- function(x, ...) {
...
print.SelectCF_hyp2d <- function(x, ...) {
  cat("Lasso Type: ", x$lassotype_full, fill=TRUE)
...
print.SelectCF_base_gapstat <- function(x, ...) {
...
plot.SelectCF_base_gapstat <- function(x, ...) {
