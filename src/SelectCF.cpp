...
// [[Rcpp::export]]
List SelectCF_getuw_lasso(NumericMatrix ds_,
...
// [[Rcpp::export]]
List SelectCF_getuw_lasso_lagrange(NumericMatrix ds_,
...
// Fused Lasso ------
// [[Rcpp::export]]
List SelectCF_getuw_fl(NumericMatrix ds_,
...
// [[Rcpp::export]]
List SelectCF_getuw_ssl(NumericMatrix ds_,
...
// [[Rcpp::export]]
List SelectCF_get_crit(NumericMatrix ds_,
                       NumericVector w_) {
  // Declarations
  int n2 = ds_.nrow();
  int p = ds_.ncol();
...
// Get u given D and w
// [[Rcpp::export]]
List SelectCF_get_u(NumericMatrix ds_,
                    NumericVector w_) {
  // Declarations
  int n2 = ds_.nrow();
  int p = ds_.ncol();
